// $Header: /usr/people/mbwall/src/galib/ga/RCS/GABin2DecGenome.h,v 1.5 1999/03/30 02:40:40 mbwall Exp $
/* ----------------------------------------------------------------------------
  bin2dec.h
  mbwall 19apr95
...
public:
  ...
  friend int operator==(const GABin2DecPhenotype&, const GABin2DecPhenotype&);
  friend int operator!=(const GABin2DecPhenotype&, const GABin2DecPhenotype&);
