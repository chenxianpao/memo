...
The change records:
    ...
    2014/5/17        QCQ        To fix the function value
'''
import rosetta
import numpy as np
import math
...
def ConditionOne(matrix):
    ...
    third_small_vector = temporary_matrix[-2,:]
...
def ConditionTwo(matrix, support_vector):
   ...
   # print "dia",diagonal_vector
    #print "th",third_small_vector
   # print '0-1',support_vector[0, :]
...
def EstimatedValue(matrix, convertedusr_vector, M):
    ...
    for item in range(max(diagonal_vector.shape)):
        value_list.append(convertedusr_vector[0, item] / diagonal_vector[item])
